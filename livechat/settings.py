...
SECRET_KEY = 'django-insecure-_u2mb#e5oh3@6xu5l!)fm2&bzvn$k8px=itpo3l#zzdtzn7r7t'
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True,  # Enable searching for templates in app-specific 'templates' folders
        'OPTIONS': {
            'context_processors': [
